...
def check_for_updates():
    ...
    fver = requests.get(
        "https://raw.githubusercontent.com/Incredible-Hacker/TBomb2.0/master/.version"
    ).text.strip()
    if fver != __VERSION__:
...
def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/Incredible-Hacker/TBomb2.0/raw/dev/.notify"
        else:
            url = "https://github.com/Incredible-Hacker/TBomb2.0/raw/master/.notify"
...
def selectnode(mode="sms"):
    ...
    try:
        ...
        max_limit = {"sms": 1000000, "call": 1500, "mail": 20000}
        cc, target = "", ""
        if mode in ["sms", "call"]:
...
__CONTRIBUTORS__ = ['SpeedX', 'IncredibleHacker', 'scpketer', 'Stefan']
